...
// promo
apiRouter.post('/api/v1/promo', cloudStorage.single('photo'), controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.promoController.handleCreatePromo);
apiRouter.get('/api/v1/promo', controllers.api.v1.promoController.handleGetAllPromo);
apiRouter.put('/api/v1/promo/:id', controllers.api.v1.authController.authorizeAdmin, cloudStorage.single('photo'), controllers.api.v1.promoController.handleUpdatePromo);
apiRouter.get('/api/v1/promo/:id', controllers.api.v1.promoController.handleGetByIdPromo);
apiRouter.post('/api/v1/promo/search', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.promoController.handleFindPromo);
apiRouter.delete('/api/v1/promo/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.promoController.handleDeletePromo);
...
apiRouter.post('/api/v1/planes', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.planeController.handleCreatePlane);
apiRouter.put('/api/v1/planes/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.planeController.handleUpdatePlane);
apiRouter.get('/api/v1/planes/:id', controllers.api.v1.planeController.handleGetPlane);
apiRouter.delete('/api/v1/planes/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.planeController.handleDeletePlane);

//ticket routes
apiRouter.get('/api/v1/ticket', controllers.api.v1.ticketController.handleListTicket);
apiRouter.post('/api/v1/ticket', controllers.api.v1.authController.authorizeAdmin, cloudStorage.single('photo'), controllers.api.v1.ticketController.handleCreateTicket);
apiRouter.put('/api/v1/ticket/:id', controllers.api.v1.authController.authorizeAdmin, cloudStorage.single('photo'), controllers.api.v1.ticketController.handleUpdateTicket);
apiRouter.get('/api/v1/ticket/:id', controllers.api.v1.ticketController.handleGetTicket);
apiRouter.delete('/api/v1/ticket/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.ticketController.handleDeleteTicket);

//wishlist routes
apiRouter.get('/api/v1/wishlist', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.wishlistController.handleListWishlist);
...
apiRouter.delete('/api/v1/airport/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.airportConroller.handleDeleteAirport);

// flight
apiRouter.get('/api/v1/flight', controllers.api.v1.flightContoller.handleGettAllFliht);
apiRouter.post('/api/v1/flight', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.flightContoller.handleCreateFligh);
apiRouter.put('/api/v1/flight/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.flightContoller.handleUpdateFlight);
apiRouter.get('/api/v1/flight/:id', controllers.api.v1.flightContoller.handleGetByPk);
apiRouter.delete('/api/v1/flight/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.flightContoller.handleDeleteFlight);


// transaction
apiRouter.get('/api/v1/transaction', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.transactionController.handleListTransaction);
...
apiRouter.delete('/api/v1/transaction/:id', controllers.api.v1.authController.authorizeAdmin, controllers.api.v1.transactionController.handleDeleteTransaction);
